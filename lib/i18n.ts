...
const translations = {
  id: {
    ...
    seafood: 'Seafood', soup: 'Sup', all_you_can_eat: 'Makan Sepuasnya',
    // Cart
    ...
    orderProcessing: 'Pesananmu masuk ke dapur!',
    orderWaiting: 'Menunggu dapur',
  ...
  en: {
    ...
    seafood: 'Seafood', soup: 'Soup', all_you_can_eat: 'All You Can Eat',
    ...
    orderProcessing: 'Your order is on its way to the kitchen!',
    orderWaiting: 'Waiting for kitchen',
  ...
  ar: {
    ...
    seafood: 'مأكولات بحرية', soup: 'شوربة', all_you_can_eat: 'أكل بلا حدود',
    ...
    orderProcessing: 'طلبك في طريقه إلى المطبخ!',
    orderWaiting: 'بانتظار المطبخ',
